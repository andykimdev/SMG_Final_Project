"""
Baseline survival prediction models for BLINDED survival prediction.
Tests whether PPI network topology provides predictive value.

NOTE: These models automatically adapt to blinded features.
When n_genomic=0 (from blinded dataset), they use only:
- Protein expression
- Clinical features (Age, Sex, Race, Ancestry)
"""
