#!/usr/bin/env python3
"""
Automated hyperparameter optimization for BLINDED Graph Transformer.
Runs multiple configurations overnight, tracks best model.
BLINDED: Uses only features available at initial IHC pathology visit.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Optimize BLINDED Graph Transformer hyperparameters")
    ...
    print("="*80)
    print("BLINDED GRAPH TRANSFORMER HYPERPARAMETER OPTIMIZATION")
    print("="*80)
    print("Features: Protein expression, Age, Sex, Race, Genetic ancestry")
    print("Excluded: Cancer type, tumor stage, genomic features")
